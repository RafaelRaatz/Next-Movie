...
export const apiRatedMovies = axios({
  ...
  headers: {
    ...
    Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlNmNkM2ZkMTdmZTIxNTMxYmU4ODkwYmQyZmRhMDRiMyIsInN1YiI6IjY0NjM5YjhkZGJiYjQyMDEzNjM4ODNjYiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.ZPcVxq_-43Il-FBQe-O4fuStRkkZYp57sULDPo7QDdk'
  }
});
